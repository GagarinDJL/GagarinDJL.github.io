...
education:
  - area: 计算机科学博士
    ...
    summary: |
      博士论文方向：社交网络中的群体观点动力学建模与影响力优化算法设计。
      研究重点包括观点传播、影响力最大化、大规模网络上的优化建模与算法分析。
  ...
  - area: 信息管理与信息系统管理学学士
    ...
    date_end: 2020-06-30
    summary_home: |
      信息管理与信息系统专业本科毕业，GPA 4.0/4.33，算术平均分 92.68/100。
    summary: |
      GPA：4.0/4.33。
      算术平均分：92.68/100。
...
service:
  - category: 学术服务
    items:
      - position: 程序委员会委员
        institution: AAIM 2026 - 第 20 届算法管理信息学国际会议
      ...
      - position: 助教
        ...
        show_on_homepage: true
        summary: |
          参与《管理中的数学方法与应用》《财务与成本管理》《人因工程》等课程的教学支持、作业批改与学生辅导。
      - position: 朋辈讲师
        institution: 北京化工大学朋辈学业发展中心
        date_start: 2018-09-01
        date_end: 2020-06-30
        show_on_homepage: true
        summary: |
          面向本科生开展朋辈课程辅导与学业发展工作坊。
      - position: 研究生项目秘书
        institution: 中国科学院大学工程科学学院
        date_start: 2021-09-01
        date_end: 2023-06-30
        show_on_homepage: true
        summary: |
          组织工程管理硕士项目开题、中期和论文答辩，协助研究生招生面试与培养流程管理。
      - position: 图书馆助理
        institution: 中国科学院大学玉泉路图书馆
        date_start: 2021-09-01
        date_end: 2023-06-30
        show_on_homepage: false
        summary: |
          参与图书馆信息服务、书架整理、借阅流通支持，以及“爱读书”文化活动和年度台历制作。
  ...
  - category: 学生工作与领导经历
    items:
      - position: 研究生会主席
        ...
        show_on_homepage: true
        summary: |
          组织学生会议与校园活动，统筹“流浪猫狗摄影展”等活动，并参与学生信息管理与校园沟通工作。
      - position: 班长
        institution: 中国科学院大学工程科学学院
        date_start: 2021-09-01
        date_end: 2022-06-30
        show_on_homepage: false
        summary: |
          协调班级会议、学生事务和健康数据管理，支持学院选举等组织沟通工作。
      - position: 心理委员
        institution: 中国科学院大学 9003 班
        date_start: 2020-09-01
        date_end: 2021-07-31
        show_on_homepage: false
        summary: |
          完成学校心理委员培训，在班级内提供朋辈心理支持。
      - position: 组织部部长
        institution: 北京化工大学经济管理学院学生会
...
skills:
  ...
  - name: 机器学习与工程实现
    ...
    items:
      ...
      - name: 强化学习与图学习
        icon: hero/share
      - name: Git、Linux、Jupyter 下的可复现实验流程
...
awards:
  - title: 国家青年人才托举工程博士生专项计划（首批）
    homepage_title: 国家青年人才托举工程
    date: '2024-12-01'
    awarder: 中国科学技术协会
    icon: hero/sparkles
    show_on_homepage: true
    order: 1
    summary: |
      入选中国科协首批博士生专项计划，该项目面向优秀博士研究生，支持青年科技人才成长。
  - title: 研究生国家奖学金
    date: '2022-12-01'
    awarder: 中华人民共和国教育部
...
她已发表和投稿中的工作涉及**信息扩散**、**群体行为**、**符号网络交互**、**AI 生成内容溯源**和**资源扩散**等方向。更广泛地说，她关注问题驱动的交叉研究，尤其是将有实际背景的社会、商业和技术问题转化为可计算的决策问题。
